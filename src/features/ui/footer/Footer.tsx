...
export const Footer: React.FunctionComponent = (): ReactElement => {
  ...
  return (
    <div data-testid='footer'>
      <div>
        <div className='w-full drop-shadow-[10px_35px_35px_rgba(93,58,183,0.49)]'>
          <footer id='App-footer' className='absolute w-full z-50 bottom-0 bg-primary-custom py-5'>
